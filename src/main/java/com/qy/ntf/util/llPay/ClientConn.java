...
public class ClientConn {
  ...
  public ClientResult clientSend(ClientParams clientParams) {
    ...
    if (null == obj_sendType) {
      ...
      clientResult.setRes_value(ClientGlobals.res_msg_failed_request_sendtype_invalid);
      return clientResult;
    }
  ...
  private ClientResult clientSendHttp(ClientParams ClientParams) {
    ...
    if (null == clientResult) {
      clientHttp.logHttp(
          ClientGlobals.res_code_exception, ClientGlobals.res_msg_exception_parse_res_returMapnull);
      clientResult = new ClientResult();
      clientResult.setRes_code(ClientGlobals.res_code_exception);
      clientResult.setRes_value(ClientGlobals.res_msg_exception_parse_res_returMapnull);
    }
    return clientResult;
  }

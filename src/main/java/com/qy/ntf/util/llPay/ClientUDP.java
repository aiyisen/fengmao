...
public class ClientUDP {
   ...
   * @throws IOException
   */
  public synchronized String ClientSendForUDP(
      byte[] prefix, String serviceId, String host, String sport) {
    ...
    try {
      ...
      DatagramPacket packet =
          new DatagramPacket(sendByte, sendLength, address, Integer.parseInt(sport));

...
/** http连接相关参数 @创建人： 郭锐 @创建时间：2010-9-9 下午02:47:00 */
public class ClientGlobals {
  public static final String client_send_type_http = "http";
  public static final String client_send_type_activemq = "activemq";
  // request
  public static final String http_request_connection_timeout_key =
      "http.connection.timeout"; // 连接超时
  ...
  public static final String http_request_params_content_type_stream =
      "application/octet-stream"; // 类型

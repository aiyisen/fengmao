...
/**
 * @创建人： 郭锐 @创建时间：2010-9-10 下午01:58:27
 */
@Slf4j
public class ClientHttp {
  ...
  public ClientResult sendHttp(ClientParams clientParams) {
    ...
    if (null == clientParams.getHttp_request_url()) {
      logHttp(ClientGlobals.res_code_failed, ClientGlobals.res_msg_failed_request_params_error);
      clientResult = new ClientResult();
      clientResult.setRes_code(ClientGlobals.res_code_failed);
      clientResult.setRes_value(ClientGlobals.res_msg_failed_request_params_error);
      return clientResult;
    }
    // 检查是否传入correlationID
  ...
  private HttpResponse sendHttp(HttpClient httpClient, HttpUriRequest method) {
    ...
    } catch (ClientProtocolException e) // 协议错误
    {
      if (null == clientResult) {
        logHttp(ClientGlobals.res_code_failed, ClientGlobals.res_msg_failed_protocol_wrong);
        clientResult = new ClientResult();
        clientResult.setRes_code(ClientGlobals.res_code_failed);
        clientResult.setRes_value(ClientGlobals.res_msg_failed_protocol_wrong);
      }
    } catch (HttpHostConnectException e) // 拒绝连接
    {
      if (null == clientResult) {
        logHttp(ClientGlobals.res_code_failed, ClientGlobals.res_msg_failed_connection_refuse);
        clientResult = new ClientResult();
        clientResult.setRes_code(ClientGlobals.res_code_failed);
        clientResult.setRes_value(ClientGlobals.res_msg_failed_connection_refuse);
      }
      return null;
    } catch (ConnectTimeoutException e) // 连接超时
    {
      if (null == clientResult) {
        logHttp(ClientGlobals.res_code_failed, ClientGlobals.res_msg_failed_connection_timeout);
        clientResult = new ClientResult();
        clientResult.setRes_code(ClientGlobals.res_code_failed);
        clientResult.setRes_value(ClientGlobals.res_msg_failed_connection_timeout);
      }
    } catch (IOException e) // 读取响应超时
    {
      if (null == clientResult) {
        logHttp(ClientGlobals.res_code_exception, ClientGlobals.res_msg_exception_socket_timeout);
        clientResult = new ClientResult();
        clientResult.setRes_code(ClientGlobals.res_code_exception);
        clientResult.setRes_value(ClientGlobals.res_msg_exception_socket_timeout);
      }
    }
    return result;
  }
  ...
  private ClientResult postObject(ClientParams clientParams) {
    ...
    try {
      ...
      httpClient
          .getParams()
          .setParameter(
              ClientGlobals.http_request_socket_timeout_key, clientParams.getHttp_socket_timeout());
      HttpPost httpPost = new HttpPost(clientParams.getHttp_request_url());
      httpPost.setHeader("Content-Type", clientParams.getHttp_content_type());
      ...
      try {
        ...
        logHttp(ClientGlobals.res_code_failed, ClientGlobals.res_msg_failed_parse_inputparam);
        clientResult = new ClientResult();
        clientResult.setRes_code(ClientGlobals.res_code_failed);
        clientResult.setRes_value(ClientGlobals.res_msg_failed_parse_inputparam);
      } finally {
        if (null != out) {
          try {
            out.flush();
            ...
            if (null == clientResult) {
              ...
              clientResult = new ClientResult();
              clientResult.setRes_code(ClientGlobals.res_code_failed);
              clientResult.setRes_value(ClientGlobals.res_msg_failed_parse_inputparam_close);
            }
          }
        }
        if (null != clientResult) return clientResult;
      }
      ...
      if (null != response) {
        ...
        if (statusCode != 200) {
          logHttp(
              ClientGlobals.res_code_failed, ClientGlobals.res_msg_failed_response_error_status);
          clientResult = new ClientResult();
          clientResult.setRes_code(ClientGlobals.res_code_failed);
          clientResult.setRes_msg(ClientGlobals.res_msg_failed_response_error_status);
          return clientResult;
        }
        ...
        if (resEntity != null) {
          ...
          try {
            ...
            clientResult = new ClientResult();
            clientResult.setRes_code(ClientGlobals.res_code_exception);
            clientResult.setRes_value(ClientGlobals.res_msg_exception_parse_res_illegalstate);
          } catch (IOException e) {
            logHttp(ClientGlobals.res_code_exception, ClientGlobals.res_msg_exception_parse_res_io);
            clientResult = new ClientResult();
            clientResult.setRes_code(ClientGlobals.res_code_exception);
            clientResult.setRes_value(ClientGlobals.res_msg_exception_parse_res_io);
            ...
            clientResult = new ClientResult();
            clientResult.setRes_code(ClientGlobals.res_code_exception);
            clientResult.setRes_value(ClientGlobals.res_msg_exception_parse_res_classnotfound);
          } finally {
            if (null != clientResult) return clientResult;
          }
        } else {
          ...
          clientResult = new ClientResult();
          clientResult.setRes_code(ClientGlobals.res_code_exception);
          clientResult.setRes_msg(ClientGlobals.res_msg_exception_parse_res_entitynull);
          return clientResult;
        }
      } else {
        logHttp(ClientGlobals.res_code_exception, ClientGlobals.res_msg_exception_parse_res_null);
        clientResult = new ClientResult();
        clientResult.setRes_code(ClientGlobals.res_code_exception);
        clientResult.setRes_msg(ClientGlobals.res_msg_exception_parse_res_null);
        return clientResult;
      }
      clientResult = new ClientResult();
  ...
  private ClientResult postHttp(ClientParams clientParams) {
    ...
    try {
      ...
      log.info("http请求:correlationID:" + getCorrelationID() + "[" + bodyString + "]");
      // 传入Post参数
      ...
      try {
        ...
        if (null == clientResult) {
          ...
          clientResult = new ClientResult();
          clientResult.setRes_code(ClientGlobals.res_code_failed);
          clientResult.setRes_msg(ClientGlobals.res_msg_failed_parse_inputparam);
        }
      } finally {
        if (null != clientResult) return clientResult;
      }
        ...
        if (resEntity != null) {
          try {
            ...
            if (null == clientResult) {
              ...
              clientResult = new ClientResult();
              clientResult.setRes_code(ClientGlobals.res_code_exception);
              clientResult.setRes_msg(ClientGlobals.res_msg_exception_parse_res_illegalstate);
            }
          } catch (IOException e) {
            if (null == clientResult) {
              logHttp(
              ...
              clientResult = new ClientResult();
              clientResult.setRes_code(ClientGlobals.res_code_exception);
              clientResult.setRes_msg(ClientGlobals.res_msg_exception_parse_res_consumecontent);
            }
          } finally {
            if (null != clientResult) return clientResult;
          }
      ...
      log.info("http响应:correlationID:" + getCorrelationID() + "[" + returnvalue + "]");
      clientResult = new ClientResult();
      clientResult.setRes_code(ClientGlobals.res_code_success);
      clientResult.setRes_msg(ClientGlobals.res_msg_success);
      clientResult.setRes_value(returnvalue);
      return clientResult;
    } finally { // httpclient资源释放
      if (null != httpClient) httpClient.getConnectionManager().shutdown();
    }
  }
  ...
  private ClientResult getHttp(ClientParams clientParams) {
    ...
    try {
      ...
      httpGet.setHeader("Content-Type", clientParams.getHttp_content_type());
      log.info(
          "http请求:correlationID:"
              + getCorrelationID()
              + "["

...
/**
 * @ClassName: SDKConfig @Description:
 *
 * @version 2.0.0
 */
public class SDKConfig {
  ...
  public void loadPropertiesFromSrc() {
    ...
    try {
      logger.info(
          "从classpath: "
              + SDKConfig.class.getClassLoader().getResource("").getPath()
              + " 获取属性文件"
              + FILE_NAME);
  ...
  public String getUrl() {
    return Strings.isEmpty(url) ? "https://caspay.sandpay.com.cn/agent-main/openapi/" : url;
  }

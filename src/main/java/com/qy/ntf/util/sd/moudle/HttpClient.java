 ...
 *
 * <p>(C) Copyright of Sand Co., Ltd. 2010 All Rights Reserved.
 *
 * <p>Modification History:
 * ============================================================================= Author Date
 * Description ------------ ---------- --------------------------------------------------- 企业产品团队
 * 2016-10-12 Http通讯工具类.
 * =============================================================================
 */
package com.qy.ntf.util.sd.moudle;
...
/**
 * @ClassName: HttpClient @Description: 主要用于Http通讯
 *
 * @version 2.0.0
 */
public class HttpClient {
  ...
  public static String doPost(
      String url, Map<String, String> params, String charset, int connectTimeout, int readTimeout)
      throws IOException {
  ...
  public static String doPost(
    ...
    try {
      HttpPost httpPost =
          getHttpPost(targetUrl, headers, params, charset, connectTimeout, readTimeout);
  ...
  public static String doGet(
      String url, Map<String, String> headers, Map<String, String> params, final String charset)
      throws IOException {
   ...
   * // * @param isProxy
   *
   * @param targetUrl @param headers @param params @param charset @param connectTimeout @param
   *     readTimeout @return @throws IOException @throws
   */
  private static HttpPost getHttpPost(
    ...
    RequestConfig requestConfig =
        RequestConfig.custom()
            ...
            .setConnectTimeout(
                connectTimeout) // Connection timeout is the timeout until a connection with the

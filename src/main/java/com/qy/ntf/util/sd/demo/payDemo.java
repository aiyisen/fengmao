...
public class payDemo {
  public static void main(String[] args) {
    ...
    // 商户key1
    String mer_key = "umHmjAizLtkUOLwwELgo4pQ0dTXC4E6yzTfu2hYJYdr1s0RR9txsWRi8SnFiZqwY9XyYsHlpnL8=";
    // 订单号
    ...
    String pay_extra = "{\"userId\":\"666666\"}";
    ...
    map.put("create_ip", "61_176_37_39");

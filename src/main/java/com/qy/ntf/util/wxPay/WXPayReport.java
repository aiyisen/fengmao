...
public class WXPayReport {
  ...
  public static class ReportInfo {
    ...
    public ReportInfo(
        ...
        int firstConnectTimeoutMillis,
        int firstReadTimeoutMillis,
        boolean firstHasDnsError,
        boolean firstHasConnectTimeout,
              ...
              public void run() {
                while (true) {
                  ...
                  try {
                    ...
                    // 上报
                    WXPayReport.httpRequest(
                        sb.toString(), DEFAULT_CONNECT_TIMEOUT_MS, DEFAULT_READ_TIMEOUT_MS);
                  } catch (Exception ex) {
  ...
  private static String httpRequest(String data, int connectTimeoutMs, int readTimeoutMs)
    ...
    httpPost.addHeader("User-Agent", "wxpay sdk java v1.0 "); //  很重要，用来检测 sdk 的使用情况，要不要加上商户信息？

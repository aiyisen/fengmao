...
public class HttpServiceEx extends HttpService {
  ...
  private static OkHttpClient createOkHttpClient() {
    ...
    builder
        ...
        .readTimeout(ConfigCache.get().getConnectTimeout(), TimeUnit.SECONDS)
        .build();
  ...
  protected InputStream performIO(String request) throws IOException {
    ...
    Request httpRequest =
        (new Request.Builder())
            .url("https://opbningxia.bsngate.com:18602/api/ba851d44d7524798bc5d3218a85df6fd/evmrpc")
            .headers(headers)
            .post(requestBody)
            .build();

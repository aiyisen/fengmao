...
import com.qy.ntf.util.wenchang.contract.DDC721;
...
public class DDC721Service extends BaseService {
  ...
  /**
   * Generate DDC The platform party or end user can generate DDC by calling this method.
   *
  ...
  public String mint(String sender, String to, String ddcURI) throws Exception {
    ...
    // 6.签名并发送，最终返回交易hash
    return signAndSend(ddc721, DDC721.FUNC_MINT, encodedFunction, signEventListener, sender)
        .getTransactionHash();
  }
  ...
  public String safeMint(String sender, String to, String ddcURI, byte[] data) throws Exception {
    ...
    return signAndSend(ddc721, DDC721.FUNC_SAFEMINT, encodedFunction, signEventListener, sender)
        .getTransactionHash();
  }

  /**
   * DDC authorization The DDC owner can authorize the DDC by calling this method, and the initiator
   * needs to be the owner of the DDC.
   *
   * @param sender Caller address
  ...
  public String approve(String sender, String to, BigInteger ddcId) throws Exception {
    ...
    return signAndSend(ddc721, DDC721.FUNC_APPROVE, encodedFunction, signEventListener, sender)
        .getTransactionHash();
  }

  /**
   * DDC authorization query The operator, the platform or the end user can query the authorization
   * status of the DDC by calling this method.
   *
   * <p><<<<<<< HEAD
   *
   * @param ddcId DDC unique identifier
   ...
   * @param ddcId DDC唯一标识
   * @return 授权的账户 >>>>>>> 3c79aa6bb5cdfea77ee38603cba817a3d3f04b3b
   * @throws Exception Exception
   */
  ...
  public String setApprovalForAll(String sender, String operator, Boolean approved)
    ...
    return signAndSend(
            ddc721, DDC721.FUNC_SETAPPROVALFORALL, encodedFunction, signEventListener, sender)
        .getTransactionHash();
  }
  ...
  /**
   * Safe transfer of DDC The owner or authorizer of DDC can transfer DDC by calling this method.
   *
   * @param sender Caller address
  ...
  public String safeTransferFrom(
      String sender, String from, String to, BigInteger ddcId, byte[] data) throws Exception {
    if (!AddressUtils.isValidAddress(sender)) {
      throw new DDCException(ErrorMessage.SENDER_ACCOUNT_IS_NOT_ADDRESS_FORMAT);
    }
    ...
    return signAndSend(
            ddc721, DDC721.FUNC_SAFETRANSFERFROM, encodedFunction, signEventListener, sender)
        .getTransactionHash();
  }

  /**
   * Transfer The DDC owner or authorizer can transfer DDC by calling this method.
   *
   * @param sender Caller address
   * @param from Owner account
   * @param to Recipient account
   ...
   * @throws Exception Exception
   */
  public String transferFrom(String sender, String from, String to, BigInteger ddcId)
      throws Exception {
    if (!AddressUtils.isValidAddress(sender)) {
      throw new DDCException(ErrorMessage.SENDER_ACCOUNT_IS_NOT_ADDRESS_FORMAT);
    }
    ...
    return signAndSend(ddc721, DDC721.FUNC_TRANSFERFROM, encodedFunction, signEventListener, sender)
        .getTransactionHash();
  }
  ...
  public String freeze(String sender, BigInteger ddcId) throws Exception {
    ...
    return signAndSend(ddc721, DDC721.FUNC_FREEZE, encodedFunction, signEventListener, sender)
        .getTransactionHash();
  }
  ...
  public String unFreeze(String sender, BigInteger ddcId) throws Exception {
    ...
    return signAndSend(ddc721, DDC721.FUNC_UNFREEZE, encodedFunction, signEventListener, sender)
        .getTransactionHash();
  }

  /**
   * Burn DDC owner or DDC authorizer can destroy DDC by calling this method
   *
   * @param sender Caller address
   * @param ddcId DDC unique identifier
   * @return hash, Transaction hash
  ...
  public String burn(String sender, BigInteger ddcId) throws Exception {
    ...
    return signAndSend(ddc721, DDC721.FUNC_BURN, encodedFunction, signEventListener, sender)
        .getTransactionHash();
  }
  ...
  /**
   * Query owner Operators, platform parties and end users can query the current DDC owner by
   * calling this method.
   *
   * @param ddcId DDC unique identifier
  ...
  /**
   * Get name Operators, platform parties and end users can query the name of the current DDC by
   * calling this method.
   *
  ...
  /**
   * Get symbol The operator, the platform and the end user can query the current DDC symbol by
   * calling this method.
   *
  ...
  public String setURI(String sender, BigInteger ddcId, String ddcURI) throws Exception {
    ...
    return signAndSend(ddc721, DDC721.FUNC_SETURI, encodedFunction, signEventListener, sender)
        .getTransactionHash();
  }
}

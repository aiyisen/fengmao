...
/**
 * @author 王振读 2022-05-25 19:27:16 DESC : 聚合池商品快照 添加参数
 */
@Data
@ApiModel(value = "聚合池商品快照 添加参数", description = "聚合池商品快照 添加参数")
public class OrderProPoolRecordAddDto extends BaseEntity {

...
/**
 * @author 王振读 email Created on 2022-05-25 19:27:16 DESC : 实物商品订单 查询参数
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "实物商品订单 查询参数", description = "实物商品订单 查询参数")
public class OrderProductSelectDto extends BaseEntity {

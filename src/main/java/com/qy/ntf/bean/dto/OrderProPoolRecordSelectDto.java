...
/**
 * @author 王振读 email Created on 2022-05-25 19:27:16 DESC : 聚合池商品快照 查询参数
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "聚合池商品快照 查询参数", description = "聚合池商品快照 查询参数")
public class OrderProPoolRecordSelectDto extends BaseEntity {

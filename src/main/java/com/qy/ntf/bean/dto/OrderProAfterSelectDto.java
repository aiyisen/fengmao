...
/**
 * @author 王振读 email Created on 2022-06-13 22:37:54 DESC : 权益商城售后订单 仅退款014 退货退款0234 退货024 查询参数
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(
    value = "权益商城售后订单 仅退款014 退货退款0234 退货024 ",
    description = "权益商城售后订单 仅退款014 退货退款0234 退货024 ")
public class OrderProAfterSelectDto extends BaseEntity {

...
/**
 * @author 王振读 email Created on 2022-05-25 19:27:16 DESC : 余额记录 查询参数
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "余额记录 查询参数", description = "余额记录 查询参数")
public class ConBalanceRecordSelectDto extends BaseEntity {

...
/**
 * @author 王振读 email Created on 2022-05-25 19:27:16 DESC : 平台信息 修改参数
 */
@Data
@Slf4j
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "平台信息 修改参数", description = "平台信息 修改参数")
public class SysPlateConfigUpdateDto extends BaseEntity {

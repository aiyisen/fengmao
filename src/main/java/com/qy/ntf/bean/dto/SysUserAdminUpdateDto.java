...
/**
 * @author 王振读 email Created on 2022-05-31 22:14:55 DESC : 管理员表 修改参数
 */
@Data
@Slf4j
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "管理员表 修改参数", description = "管理员表 修改参数")
public class SysUserAdminUpdateDto extends BaseEntity {

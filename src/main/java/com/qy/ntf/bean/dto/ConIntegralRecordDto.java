...
import lombok.Data;
/**
 * @author 王振读 2022-05-25 19:27:16 DESC : 积分流水记录（记录总和>=0) 添加参数
 */
@Data
@ApiModel(value = "积分流水记录（记录总和>=0) 添加参数", description = "积分流水记录（记录总和>=0) 添加参数")
public class ConIntegralRecordDto extends BaseEntity {
  ...
  @ApiModelProperty(
      value = "积分记录类型0登录赠送1邀请好友赠送2订单消费3刷一刷",
      example = "积分记录类型0登录赠送1邀请好友赠送2订单消费3刷一刷",
      required = true)

...
/**
 * @author 王振读 email Created on 2022-06-17 22:00:33 DESC : vip购买订单 修改参数
 */
@Data
@Slf4j
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "vip购买订单 修改参数", description = "vip购买订单 修改参数")
public class OrderVipUpdateDto extends BaseEntity {

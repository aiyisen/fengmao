...
/**
 * @author 王振读 email Created on 2022-05-25 19:27:16 DESC : 实物商品快照 修改参数
 */
@Data
@Slf4j
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "实物商品快照 修改参数", description = "实物商品快照 修改参数")
public class OrderProductRecordUpdateDto extends BaseEntity {

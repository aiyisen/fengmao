...
/**
 * @author 王振读 email Created on 2022-05-25 19:27:16 DESC : 藏品快照 查询参数
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "藏品快照 查询参数", description = "藏品快照 查询参数")
public class OrderTreasureRecordSelectDto extends BaseEntity {

...
/**
 * @author 王振读 email Created on 2022-05-25 19:27:16 DESC : 实物商品快照 查询参数
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "实物商品快照 查询参数", description = "实物商品快照 查询参数")
public class OrderProductRecordSelectDto extends BaseEntity {
  ...
  /** order_product.id */
  @ApiModelProperty(value = "order_product.id", example = "order_product.id", required = false)
  ...
  /** 详情（富文本） */
  @ApiModelProperty(value = "详情（富文本）", example = "详情（富文本）", required = false)

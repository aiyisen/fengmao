...
/**
 * @author 王振读 email Created on 2022-05-25 19:27:16 DESC : 充值订单表 查询参数
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "充值订单表 查询参数", description = "充值订单表 查询参数")
public class ConRechargeSelectDto extends BaseEntity {

...
/**
 * @author 王振读 email Created on 2022-05-25 19:27:16 DESC : 聚合池商品快照 修改参数
 */
@Data
@Slf4j
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "聚合池商品快照 修改参数", description = "聚合池商品快照 修改参数")
public class OrderProPoolRecordUpdateDto extends BaseEntity {

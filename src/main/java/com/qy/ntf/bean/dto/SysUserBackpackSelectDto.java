 ...
 * DESC : 用户背包（记录虚拟商品购买订单标识） 查询参数
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "用户背包（记录虚拟商品购买订单标识） 查询参数", description = "用户背包（记录虚拟商品购买订单标识） 查询参数")
public class SysUserBackpackSelectDto extends BaseEntity {
